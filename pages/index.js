    ...
    <Layout>
      <div className="space-y-10">
        <div className="flex flex-col-reverse md:flex-row md:items-center md:justify-between">
          <div className="flex flex-col md:w-3/4 space-y-1 mt-6">
            <h1 className="text-4xl font-bold">The Mixed Stack Blog</h1>
            <p className="text-lg">
        ...
        <div className="space-y-2">
          {posts.map((post) => (
            <div className="md:w-4/5" key={post.filePath}>
              ...
              >
                <a>
                  <h5 className="text-xl font-bold hover:text-teal">{post.data.title}</h5>
                  <h6 className="text-lg">{post.data.description}</h6>
                </a>
              </Link>
